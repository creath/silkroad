...
uint256 hashGenesisBlock("0x00000741146ce091671a1619f0f2dd55bbc754a845d74317d93bf6b1e07fffb0");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // silkroadcoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "silkroadcoin Signed Message:\n";
...
{
    // silkroadcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    // silkroadcoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
	...
	// Mainnet Genesis block:
		...
		const char* pszTimestamp = "silkroadcoin genesis block";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1532572388;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1153681;
	...
	//// debug print
        ...
        assert(block.hashMerkleRoot == uint256("0x1b2bdf96855ef2192e256ceb7e3a882547734813d2da59d4629cf01bad58f0b7"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfe, 0xc3, 0xb9, 0xde }; // silkroadcoin: increase each by adding 6 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("silkroadcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("silkroadcoinMiner : ProcessBlock, block not accepted");
    }
